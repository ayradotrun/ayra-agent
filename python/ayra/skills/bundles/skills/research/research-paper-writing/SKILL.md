...
## AYRA Agent Integration

This skill is designed for the AYRA agent. It uses AYRA tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other AYRA skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.ayra/plans/` | `skill_view("plan")` |
