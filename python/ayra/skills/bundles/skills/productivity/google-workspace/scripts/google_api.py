#!/usr/bin/env python3
"""Google Workspace API CLI for AYRA Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing AYRA-facing JSON contract and falls back to the Python client
...
from _ayra_home import get_ayra_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for AYRA Agent")
