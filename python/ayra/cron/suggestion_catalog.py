...
These are the built-in automations AYRA can offer a new user out of the box —
    ...
    CatalogEntry(
        ...
        job_spec={
            "prompt": (
                ...
                "--threshold 7 --criteria ...` from the ayra-agent install — "
...
def seed_catalog_suggestions(
    *,
    ...
    """
    if add_fn is None:
        from ayra.cron.suggestions import add_suggestion as add_fn  # type: ignore[assignment]
